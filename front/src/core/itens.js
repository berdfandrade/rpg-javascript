...
export function mostrarTodosOsItens(items) {
  items = [
...
export default mostrarTodosOsItens

// export function obterItensAleatorios(lista) {
...
// export function buscarItem(items, termo) {
...
// export default {todosOsItems, buscarItem, obterItensAleatorios} 